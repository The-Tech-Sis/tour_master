...
if(isset($_POST['save_data'])){
  ...
  $query = "INSERT INTO booking_fm (destination, people, checkin, checkout) values ('$destination', '$people', '$checkin', '$checkout')";
  ...
  if($query){
    ...
    $_SESSION['status'] = "Date not inserted";
...
<!-- 
    ...
    <div class="header-bottom">
      <div class="container">
        ...
        <button class="btn btn-primary"> <a href="login_form.php">Book Now</a> </button>
    ...
    <article>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <div class="btn-group">
            <button class="btn btn-primary"><a href="#destination">Learn more </a></button>

            <button class="btn btn-secondary"><a href="login_form.php">Book now </a>  </button>
          </div>
      ...
      <section class="tour-search">
        <div class="container">
          ...
          <form action="index.php" method="POST" class="tour-search-form">
            ...
            <button type="submit" name="save_data" class="btn btn-secondary">Inquire now</button>
      ...
      <section class="popular" id="destination">
        <div class="container">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  ...
                  <img src="../assets/images/popular-1.jpg" alt="San miguel, italy" loading="lazy"></a>
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <a href="destination.html">
                  ...
                  <img src="../assets/images/popular-2.jpg" alt="Burj khalifa, dubai" loading="lazy"> </a>
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <a href="destination.html">
                  ...
                  <img src="../assets/images/popular-3.jpg" alt="Kyoto temple, japan" loading="lazy"></a>
                </figure>
          ...
          <button class="btn btn-primary">  <a href="destination.html">More destintion</a></button>
      ...
      <section class="cta" id="contact">
        <div class="container">
          ...
          <div class="cta-content">
            <div class="image">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.3005654391322!2d6.078202168848614!3d6.733137694496126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104695a7be6eb38d%3A0xfb1e7b68ed3d257c!2sFaculty%20Of%20Physical%20Sciences!5e0!3m2!1sen!2sng!4v1668431125742!5m2!1sen!2sng" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
  ...
  <footer class="footer">
        ...
        <div class="footer-contact">
          ...
          <ul>
            ...
            <li class="contact-item">
              ...
              <a href="tel:+01123456790" class="contact-link">+2348182227408</a>
            </li>
            ...
            <li class="contact-item">
              ...
              <address>2nd floor, Physical Science</address>
            </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022 <a href="">Dev's</a>. All rights reserved
        </p>
